            ...
            <div className="container">
                ...
                <div className="row ">
                    <div className="col-sm-6 text-center">
                        <h5 className="fw-bold bg-dark text-light">Our Address</h5>
                        <address>
                            1  Way<br />
                            Absecon, NJ 08201<br />
                            U.S.A.
                    ...
                    <div className="col-sm-6 text-center ">
                        <h5 className="fw-bold bg-dark text-light">Talk to us@</h5>
                ...
                <div className="row">
                     ...
                     <div className="col-md-10">
                         <Form onSubmit={this.handleSubmit}>
                                <FormGroup row>
                                        <Label htmlFor="firstName" md={2} className="fw-bold bg-dark text-light">First Name</Label>
                                        <Col md={10}>
                                ...
                                <FormGroup row>
                                    <Label htmlFor="phoneNum" md={2} className="fw-bold bg-dark text-light">Phone</Label>
                                    <Col md={10}>
                               ...
                               <FormGroup row>
                                    <Label htmlFor="feedback" md={2} className="fw-bold bg-dark text-light">Your Feedback</Label>
                                    <Col md={10}>
